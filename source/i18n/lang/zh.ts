...
export const zh: TranslationKeys = {
	...
	configScreen: {
		...
		vcpTimeBridge: 'Snow VCP ::Time 桥接:',
		vcpTimeBridgeAuto: '自动（仅 localhost）',
		vcpTimeBridgeEnabled: '强制启用',
		vcpTimeBridgeDisabled: '强制关闭',
		vcpMode: 'Snow 后端模式:',
		vcpModeNative: 'Native mode（原生直连）',
		vcpModeVcp: 'VCP mode（VCP 兼容）',
		vcpToolTransport: 'VCP 工具传输:',
		vcpToolTransportLocal: 'Local（仅 Snow 本地工具）',
		vcpToolTransportBridge: 'Bridge（Snow + SnowBridge）',
		vcpToolBridgeWsUrl: 'SnowBridge WebSocket:',
		vcpToolBridgeToken: 'SnowBridge 访问令牌（选填）:',
		vcpToolBridgeTokenPlaceholder: '留空表示不传 bridge token',
		vcpToolBridgeToolFilter: 'SnowBridge 工具过滤（选填）:',
		vcpToolBridgeToolFilterPlaceholder: '例如 DailyNote,FileOperator,Randomness',
		vcpToolBridgeFallbackToLocal: 'SnowBridge 失败时保留本地工具:',
