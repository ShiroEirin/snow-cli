...
export const zhTW: TranslationKeys = {
	...
	configScreen: {
		...
		vcpTimeBridge: 'Snow VCP ::Time 橋接:',
		vcpTimeBridgeAuto: '自動（僅 localhost）',
		vcpTimeBridgeEnabled: '強制啟用',
		vcpTimeBridgeDisabled: '強制關閉',
		vcpMode: 'Snow 後端模式:',
		vcpModeNative: 'Native mode（原生直連）',
		vcpModeVcp: 'VCP mode（VCP 相容）',
		vcpToolTransport: 'VCP 工具傳輸:',
		vcpToolTransportLocal: 'Local（僅 Snow 本地工具）',
		vcpToolTransportBridge: 'Bridge（Snow + SnowBridge）',
		vcpToolBridgeWsUrl: 'SnowBridge WebSocket:',
		vcpToolBridgeToken: 'SnowBridge 存取令牌（選填）:',
		vcpToolBridgeTokenPlaceholder: '留空表示不傳 bridge token',
		vcpToolBridgeToolFilter: 'SnowBridge 工具過濾（選填）:',
		vcpToolBridgeToolFilterPlaceholder:
			'例如 DailyNote,FileOperator,Randomness',
		vcpToolBridgeFallbackToLocal: 'SnowBridge 失敗時保留本地工具:',
