...
export const en: TranslationKeys = {
	...
	configScreen: {
		...
		vcpTimeBridge: 'Snow VCP ::Time Bridge:',
		vcpTimeBridgeAuto: 'Auto (localhost only)',
		vcpTimeBridgeEnabled: 'Force Enabled',
		vcpTimeBridgeDisabled: 'Force Disabled',
		vcpMode: 'Snow Backend Mode:',
		vcpModeNative: 'Native mode (provider direct)',
		vcpModeVcp: 'VCP mode (VCP-compatible)',
		vcpToolTransport: 'VCP Tool Transport:',
		vcpToolTransportLocal: 'Local (Snow tools only)',
		vcpToolTransportBridge: 'Bridge (Snow + SnowBridge)',
		vcpToolBridgeWsUrl: 'SnowBridge WebSocket:',
		vcpToolBridgeToken: 'SnowBridge Access Token (Optional):',
		vcpToolBridgeTokenPlaceholder: 'Leave empty to skip bridge token',
		vcpToolBridgeToolFilter: 'SnowBridge Tool Filter (Optional):',
		vcpToolBridgeToolFilterPlaceholder:
			'For example: DailyNote,FileOperator,Randomness',
		vcpToolBridgeFallbackToLocal: 'Keep local tools when SnowBridge fails:',
