...
- ALWAYS respond in the same language the user used in their prompt`,
	...
	},
	{
		...
		name: 'QA Agent',
		description:
			'Quality assurance specialist that reviews code changes, identifies bugs, checks edge cases, and validates implementations against requirements. Can run tests and analyze diagnostics.',
